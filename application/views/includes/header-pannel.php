<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <ul class="nav navbar-top-links navbar-right">
        <li>
            <span class="m-r-sm text-muted welcome-message">Hi <?php echo $this->session->userdata['name']; ?>! Welcome to Sundas Enterprise</span>
        </li>
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-messages">
                ...
                <li>
                    <div class="text-center link-block">
                        <a href="mailbox.html">
                            <i class="fa fa-envelope"></i> <strong>Read All Emails</strong>
                        </a>
                    </div>
                </li>
            </ul>
